...
class responses(commands.Cog):
 ...
 async def merica(self,ctx):
  merica = discord.Embed(title='MERICA',description='MERICA FUCK YEAH!!!!',color=0xFFFF00)
 ...
 async def die(self,ctx):
  die = discord.Embed(title='You died lol',description=ctx.author.mention + ' was hit by a bus full of fortnite players. After they left a few tire marks on the body they got out and dabbed on them like the little shits they are. How embarrassing :man_facepalming:',color=0xFFFF00)
